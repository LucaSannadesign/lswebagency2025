import { a as createComponent, d as addAttribute, b as renderTemplate, t as defineScriptVars, c as createAstro, r as renderComponent, F as Fragment, u as unescapeHTML, s as spreadAttributes, g as renderScript, v as renderHead, e as renderSlot } from './astro/server_CxdTwKPW.mjs';
import 'kleur/colors';
/* empty css                          */
...
import { c as getImage } from './_astro_assets_BSyvYD_D.mjs';
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(I18N.language, "lang")}${addAttribute(I18N.textDirection, "dir")} class="2xl:text-[20px]"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${pageTitle}</title><meta name="description"${addAttribute(pageDescription, "content")}><meta name="robots" content="index, follow"><!-- Favicon standard --><link rel="icon" type="image/png" href="/favicon-96x96.png" sizes="96x96"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="icon" type="image/x-icon" href="/favicon.ico"><!-- Apple Touch Icon per iOS --><link rel="apple-touch-icon" href="/apple-touch-icon.png"><!-- Web App Manifest per Android e PWA --><link rel="manifest" href="/site.webmanifest"><!-- Icone per Web App --><meta name="theme-color" content="#ffffff"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><meta name="apple-mobile-web-app-title" content="LS Web Agency"><meta name="application-name" content="LS Web Agency"><meta name="msapplication-TileColor" content="#ffffff"><meta name="msapplication-TileImage" content="/web-app-manifest-192x192.png"><!-- Open Graph (Facebook, LinkedIn, WhatsApp) --><meta property="og:title"${addAttribute(pageTitle, "content")}><meta property="og:description"${addAttribute(pageDescription, "content")}><meta property="og:image"${addAttribute(pageImage, "content")}><meta property="og:type" content="website"><meta property="og:url"${addAttribute(canonicalUrl, "content")}><!-- Twitter Card --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(pageTitle, "content")}><meta name="twitter:description"${addAttribute(pageDescription, "content")}><meta name="twitter:image"${addAttribute(pageImage, "content")}><!-- Canonical --><link rel="canonical"${addAttribute(metadata.canonical ? metadata.canonical : Astro2.url.pathname, "href")}>${renderComponent($$result, "CommonMeta", $$CommonMeta, {})}${renderComponent($$result, "Favicons", $$Favicons, {})}${renderComponent($$result, "CustomStyles", $$CustomStyles, {})}${renderComponent($$result, "ApplyColorMode", $$ApplyColorMode, {})}${renderComponent($$result, "Metadata", $$Metadata, { ...metadata })}${renderComponent($$result, "SiteVerification", $$SiteVerification, {})}${renderComponent($$result, "Analytics", $$Analytics, {})}<!-- Transizioni di visualizzazione -->${renderComponent($$result, "ClientRouter", $$ClientRouter, { "fallback": "swap" })}${renderScript($$result, "/Users/lucasanna/lswebagency2025/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")}${renderHead()}</head> <body class="antialiased text-default bg-page tracking-tight"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BasicScripts", $$BasicScripts, {})} </body></html>`;
